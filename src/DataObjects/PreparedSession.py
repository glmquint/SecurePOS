class PreparedSession:
    ...
    def __init__(self, params):
        if type(params) is not dict:  # this if i create a preparedSession from a list
            self.__MeanAbsoluteDifferencingTransactionTimestamps = params[0]
            self.__MeanAbsoluteDifferencingTransactionAmount = params[1]
            self.__MedianLongitude = params[2]
            self.__MedianLatitude = params[3]
            self.__MedianTargetIP = params[4]
            self.__MedianDestIP = params[5]
