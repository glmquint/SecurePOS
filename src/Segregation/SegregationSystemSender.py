...
class SegregationSystemSender:
    ...
    def __init__(self, config: SegregationSystemConfig, learningSetGenerator):
        ...
        self.__development_sender = JSONSender(
            ...
            "http://" +
            str(development_system_ip) +
            ":" +
            str(development_system_port) +
            "/" +
            str(development_system_endpoint))
        ...
        self.__messaging_system = JSONSender(
            ...
            "http://" +
            str(messaging_system_ip) +
            ":" +
            str(messaging_system_port) +
            "/" +
            str(messaging_system_endpoint))
